...
**Current release: 0.1.4**, on Maven Central under `io.github.achird-labs`.
...
libraryDependencies ++= Seq(
  "io.github.achird-labs" % "rift-java-embedded" % "0.2.3" % Test,
  ("io.github.achird-labs" % "rift-java-natives" % "0.2.3" % Test)
